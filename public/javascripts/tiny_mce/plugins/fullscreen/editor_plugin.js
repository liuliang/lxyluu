        ...
        init:function(c,d){
            ...
            c.addCommand("mceFullScreen",function(){
                ...
                if(c.getParam("fullscreen_is_enabled")){
                    if(c.getParam("fullscreen_new_window")){
                        ...
                        a.win.setTimeout(function(){
                            ...
                            tinyMCE.get(c.getParam("fullscreen_editor_id")).setContent(c.getContent({
                                format:"raw"
                            }),{
                                format:"raw"
                            });
                ...
                f.save_onsavecallback=function(){
                    c.setContent(tinyMCE.get(f.id).getContent({
                        format:"raw"
                    }),{
                        format:"raw"
                    });
